...
from pastebin_main_app.list_pastes.list_pastes_view import ListPastes
...
urlpatterns = [
    ...
    path('paste/<str:slug>/view',PasteDetailView.as_view(), name='paste_detail_view'),
    path('list_pastes/',ListPastes.as_view(), name='list_pastes'),
    path('list_pastes',ListPastes.as_view(), name='list_pastes'),
    # when I used /paste/list_pastes check_protection somehow interfered
]